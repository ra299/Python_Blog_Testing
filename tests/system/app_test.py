...
class AppTest(TestCase):
    ...
    def test_print_post(self):
        ...
        expected_print = expected_print = "Post title , Post content"
...
#         with patch("app.print_blogs") as mocked_menu_print:
#             with patch("builtins.input", return_value = "q"):
#                 app.menu()
#                 mocked_menu_print.assert_called()
#
#     def test_print_blogs(self):
#         blog = Blog("Test", "Test Author")
#         app.blogs = {"Test": blog}
...
#             mocked_inputs.side_effect = ("Test", "Test Author")
#             app.ask_create_blog()
#             self.assertIsNotNone(app.blogs.get('Test'))
#
#     def test_ask_read_blog(self):
